...
/** This class is the controller for adding products in the Inventory Management System app. */
public class AddProductForm implements Initializable {
    ...
    /** This method initializes the "Add Product" page of the app.
    ...
    public void onRemoveButton(ActionEvent event) {
        ...
        if (selectedPart == null) {
            Alert alert = new Alert(Alert.AlertType.ERROR, "No associated part is selected.");
            alert.showAndWait();
        } else {
    ...
    /** This method takes all of the part input from the user and sets them in the corresponding variables to save as a new product.
